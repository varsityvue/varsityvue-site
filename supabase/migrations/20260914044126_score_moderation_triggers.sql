...
drop trigger if exists score_submission_reviewed on public.score_submissions;
create trigger score_submission_reviewed
before update on public.score_submissions
for each row
execute procedure public.apply_score_submission_review();
