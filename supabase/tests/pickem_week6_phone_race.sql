...
insert into public.pickem_weeks (id,season,week,title,status,opens_at,closes_at,official_rules_version,official_rules_published_at)
values ('00000000-0000-4000-8000-000000006006',2099,7,'Race fixture','draft',now()-interval '1 hour',now()+interval '10 minutes','isolated-test',now());
...
update public.pickem_weeks set tiebreaker_game_id='00000000-0000-4000-8000-000000006007',status='open' where id='00000000-0000-4000-8000-000000006006';
