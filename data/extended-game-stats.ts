...
export const extendedGameStats: ExtendedGameStats[] = [
  {
    ...
    tables: [
      ...
      { title: "Defense", headers: ["Player", "Tack", "Ast", "TFL", "Sck", "INT", "FR", "PD"], rows: [ { player: "Hunter Dale", schoolSlug: "junction", values: [0, 0, 0, 0, 0, 1, 0] }, { player: "Blaine Hall", schoolSlug: "goldthwaite", values: [0, 0, 0, 0, 1, 0, 0] }, { player: "Landry Sanderson", schoolSlug: "goldthwaite", values: [0, 0, 0, 0, 0, 1, 0] }, { player: "Hagen Greenway", schoolSlug: "goldthwaite", values: [0, 0, 0, 0, 1, 0, 0] } ] },
    ],
    notes: [ "Goldthwaite piled up 502 yards, including 283 rushing yards, in the 59-27 win.", "Landry Sanderson accounted for five touchdowns: four rushing and one receiving.", "Hayes Greenway threw for 219 yards and three touchdowns and added 72 yards and a rushing score.", "Goldthwaite intercepted two Junction passes, with Blaine Hall and Hagen Greenway recording the interceptions.", "Goldthwaite's turnover total is reconciled from the retained PressBox play-by-play: one fourth-quarter lost fumble, recovered by Junction's Hunter Dale." ],
  },
  {
