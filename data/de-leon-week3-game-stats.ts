...
export const deLeonWeek3GameStats: GameStats[] = [
  {
    ...
    rushing: [
      ...
      { player: "L. Wheeler", schoolSlug: "albany", attempts: 3, yards: 7, touchdowns: 0 },
      { player: "J. Roberson", schoolSlug: "albany", attempts: 20, yards: 84, touchdowns: 0 },
      { player: "C. Chapman", schoolSlug: "albany", attempts: 12, yards: -1, touchdowns: 0 },
    ...
    receiving: [
      ...
      { player: "B. Britting", schoolSlug: "albany", receptions: 6, yards: 58, touchdowns: 1 },
      { player: "A. Vickers", schoolSlug: "albany", receptions: 1, yards: 16, touchdowns: 0 },
      { player: "J. Roberson", schoolSlug: "albany", receptions: 4, yards: 23, touchdowns: 0 },
    ],
  },
];
