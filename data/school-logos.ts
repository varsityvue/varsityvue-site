...
const schoolLogoBySlug: Record<string, SchoolLogo> = {
  ...
  "canyon-west-plains": { path: "/logos/schools/canyon-west-plains.png", pickemScale: 1.25 },
  ...
  early: { path: "/logos/schools/early.png", pickemFilter: "brightness(1.35) contrast(1.05)", pickemScale: 1.22 },
  ...
  jacksboro: { path: "/logos/schools/jacksboro.png", pickemScale: 1.15 },
