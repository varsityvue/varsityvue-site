...
export const ciscoGameStats: GameStats[] = [
  ...
  },
  {
    ...
    rushing: [
      { player: "Zaden Tello", schoolSlug: "comanche", attempts: 8, yards: 28, touchdowns: 1 },
      { player: "Elijah Ozuna", schoolSlug: "comanche", attempts: 1, yards: 4, touchdowns: 0 },
      { player: "Damian Aguilar", schoolSlug: "comanche", attempts: 3, yards: 3, touchdowns: 0 },
      { player: "Adrian Guerrero", schoolSlug: "comanche", attempts: 1, yards: 11, touchdowns: 0 },
      { player: "Cooper Welch", schoolSlug: "comanche", attempts: 2, yards: 4, touchdowns: 0 },
      { player: "Ladanian Smith", schoolSlug: "comanche", attempts: 8, yards: 47, touchdowns: 0 },
      { player: "Nicolas Anaya", schoolSlug: "comanche", attempts: 1, yards: 3, touchdowns: 0 },
    ...
    passing: [
      { player: "Cooper Welch", schoolSlug: "comanche", completions: 8, attempts: 24, yards: 115, interceptions: 3, touchdowns: 0 },
      { player: "Colby McIlroy", schoolSlug: "cisco", completions: 11, attempts: 17, yards: 200, interceptions: 0, touchdowns: 2 },
    ],
    receiving: [
      { player: "Zaden Tello", schoolSlug: "comanche", receptions: 2, yards: 0, touchdowns: 0 },
      { player: "Damian Aguilar", schoolSlug: "comanche", receptions: 1, yards: 10, touchdowns: 0 },
      { player: "Adrian Guerrero", schoolSlug: "comanche", receptions: 2, yards: 21, touchdowns: 0 },
      { player: "Brady Gaines", schoolSlug: "comanche", receptions: 2, yards: 77, touchdowns: 0 },
