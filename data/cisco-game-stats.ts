...
export const ciscoGameStats: GameStats[] = [
  ...
  },
  {
    ...
    scoringPlays: [],
    teamStats: [
      { schoolSlug: "comanche", rushingAttempts: 24, rushingYards: 100, passingYards: 115, totalYards: 215, completions: 8, passAttempts: 24, interceptionsThrown: 3 },
    ...
    rushing: [
      { player: "Z. Tello", schoolSlug: "comanche", attempts: 8, yards: 28, touchdowns: 1 },
      { player: "E. Ozuna", schoolSlug: "comanche", attempts: 1, yards: 4, touchdowns: 0 },
      { player: "D. Aguilar", schoolSlug: "comanche", attempts: 3, yards: 3, touchdowns: 0 },
      { player: "A. Guerrero", schoolSlug: "comanche", attempts: 1, yards: 11, touchdowns: 0 },
      { player: "C. Welch", schoolSlug: "comanche", attempts: 2, yards: 4, touchdowns: 0 },
      { player: "L. Smith", schoolSlug: "comanche", attempts: 8, yards: 47, touchdowns: 0 },
      { player: "N. Anaya", schoolSlug: "comanche", attempts: 1, yards: 3, touchdowns: 0 },
    ...
    passing: [
      { player: "C. Welch", schoolSlug: "comanche", completions: 8, attempts: 24, yards: 115, interceptions: 3, touchdowns: 0 },
      { player: "Colby McIlroy", schoolSlug: "cisco", completions: 11, attempts: 17, yards: 200, interceptions: 0, touchdowns: 2 },
    ],
    receiving: [
      { player: "Z. Tello", schoolSlug: "comanche", receptions: 2, yards: 0, touchdowns: 0 },
      { player: "D. Aguilar", schoolSlug: "comanche", receptions: 1, yards: 10, touchdowns: 0 },
      { player: "A. Guerrero", schoolSlug: "comanche", receptions: 2, yards: 21, touchdowns: 0 },
      { player: "B. Gaines", schoolSlug: "comanche", receptions: 2, yards: 77, touchdowns: 0 },
      { player: "A. Molina", schoolSlug: "comanche", receptions: 1, yards: 7, touchdowns: 0 },
