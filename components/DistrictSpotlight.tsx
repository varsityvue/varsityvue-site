            ...
            <div className="mx-auto grid max-w-[1440px] gap-5 lg:grid-cols-[0.95fr_1.05fr]">
                <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-2xl md:p-8">
                    ...
                    <p className="mt-3 max-w-2xl text-sm leading-6 text-white/55">
                        One of VarsityVue&apos;s featured pilot district races, connecting
                        school hubs, schedules, standings, and matchup coverage across the
                        region.
                    </p>
                    ...
                    <div className="space-y-3">
                        {standings.map((team, index) => {
                            const school = schools.find(
                                (item) => item.slug === team.schoolSlug
                            );
