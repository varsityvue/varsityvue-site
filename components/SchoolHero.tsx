    ...
    <section className="relative overflow-hidden border-b border-white/10 text-white" style={{ background: `radial-gradient(circle at top left, ${primary}66 0%, transparent 32%), radial-gradient(circle at top right, ${secondary}22 0%, transparent 34%), linear-gradient(120deg, #050505 0%, #080808 52%, #000000 100%)` }}>
      ...
      <div className="relative mx-auto grid max-w-[1440px] gap-5 px-4 py-6 sm:px-6 sm:py-8 lg:min-h-[500px] lg:grid-cols-[1.15fr_0.85fr] lg:gap-8 lg:px-8">
        <div className="flex min-w-0 flex-col justify-between"><div className="min-w-0">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-6 text-white/62 sm:mt-7 sm:text-base sm:leading-7">{programDescription}</p>
...
function IdentityPill({ label }: { label: string }) { return <span className="rounded-full border border-white/12 bg-black/35 px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.12em] text-white/65 backdrop-blur-sm sm:px-3.5 sm:py-2 sm:text-[10px]">{label}</span>; }
