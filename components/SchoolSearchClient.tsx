...
export default function SchoolSearchClient({ schools }: { schools: School[] }) {
  ...
  return (
    <aside className="rounded-[1.6rem] border border-white/10 bg-white/[0.045] p-4 shadow-2xl sm:rounded-[2rem] sm:p-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="hidden rounded-full border border-white/10 bg-black/35 px-3 py-2 text-[10px] font-black uppercase tracking-[0.16em] text-white/45 sm:block">
          Live Hubs
        </div>
      </div>
      ...
      <div className="mt-4 max-h-[420px] overflow-y-auto pr-1 sm:mt-5">
        <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 sm:gap-3">
          {filteredSchools.length > 0 ? (
            ...
            <div className="col-span-2 rounded-xl border border-white/10 bg-black/35 p-5 text-center sm:col-span-3 sm:rounded-2xl sm:p-6">
