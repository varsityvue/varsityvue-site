          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.035] p-3.5 sm:rounded-2xl sm:p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-4xl">
                ...
                <p className="mt-1.5 text-xs leading-5 text-white/50 sm:text-sm sm:leading-6">Statistics are added as verified data is received and availability can vary by program and game. Definitive ranks are shown only when listed totals are complete; partial totals remain visible without claiming a final rank.</p>
              </div>
