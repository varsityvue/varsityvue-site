            ...
            <>
              ...
              <section className="mt-5 rounded-[1.4rem] border border-white/10 bg-white/[0.045] p-3 shadow-2xl sm:mt-8 sm:rounded-[1.75rem] sm:p-5">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                  <div className="relative min-w-0 flex-1 after:pointer-events-none after:absolute after:right-0 after:top-0 after:h-full after:w-8 after:bg-gradient-to-l after:from-[#111111] after:to-transparent sm:after:hidden">
                    <div className="overflow-x-auto pb-1 pr-7 sm:pb-0 sm:pr-0">
                  ...
                  <Link href="/submit" className="self-end rounded-full border border-white/10 bg-black/35 px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.11em] text-white/60 transition hover:bg-white/10 hover:text-white sm:shrink-0 sm:self-auto sm:px-4 sm:py-2 sm:text-xs sm:tracking-[0.14em]">Story Tip →</Link>
                </div>
              </section>
