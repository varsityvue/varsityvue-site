...
export default async function SchoolPage({ params, searchParams }: { params: Promise<{ slug: string }>; searchParams: Promise<{ followed?: string; unfollowed?: string; finishFollow?: string; followError?: string }> }) {
  const { slug } = await params;
