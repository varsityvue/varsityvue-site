    ...
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="px-4 py-5 sm:px-6 sm:py-8 lg:px-8"><div className="mx-auto max-w-7xl space-y-5 sm:space-y-8">
        ...
        <div className="grid gap-2.5 sm:gap-4 md:grid-cols-3">
          <StatCard label="Rushing" headline={player.rushing.attempts > 0 ? `${player.rushing.yards.toLocaleString()} yards` : "No stats on file"} details={player.rushing.attempts > 0 ? `${player.rushing.attempts} carries · ${formatTouchdownDetail(player.rushing.touchdowns)} · ${player.rushing.yardsPerCarry} YPC` : "Rushing totals will appear when verified."} active={player.rushing.attempts > 0} />
          ...
          <StatCard label="Receiving" headline={player.receiving.receptions > 0 ? `${player.receiving.yards.toLocaleString()} yards` : "No stats on file"} details={player.receiving.receptions > 0 ? `${player.receiving.receptions} receptions · ${formatTouchdownDetail(player.receiving.touchdowns)} · ${player.receiving.yardsPerReception} YPR` : "Receiving totals will appear when verified."} active={player.receiving.receptions > 0} />
        </div>
